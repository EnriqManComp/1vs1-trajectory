...
class EncodeState:
    ...
    def encode(self, plane_dim, state, current_player):
        ...
        first_plane, second_plane, twenty_first_plane, twenty_second_plane = self.player_encoder.encode(plane_dim=plane_dim,
        ...
        return first_plane, second_plane, third_plane, fourth_plane, twenty_first_plane, twenty_second_plane